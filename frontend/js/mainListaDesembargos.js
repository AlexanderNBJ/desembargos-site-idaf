    ...
    const view = {
        ...
        renderTabs: () => {
            ...
            pageState.tabsConfig.forEach(tabInfo => {
                ...
                if (tabInfo.id === pageState.activeTab) 
        ...
        renderRows: (rows) => {
            ...
            rows.forEach(d => {
                ...
                if (viewBtn) 
                    viewBtn.addEventListener('click', () => window.location.href = `visualizacaoDesembargo.html?id=${d.id}`);
        ...
        renderPagination: (meta) => {
            ...
            // Não renderiza nada se não houver resultados
            if (total === 0) 
                return;
            ...
            if (totalPages <= pagesToShow + 2) {
                ...
                pageLinks.push(createButton(totalPages, totalPages, false, totalPages === current));
            }
